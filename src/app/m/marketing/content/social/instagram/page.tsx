...
const BASE_COLUMNS: Column[] = [
  ...
  { key: "caption", label: "Caption", type: "textarea", width: "300px" },
  ...
  { key: "engagement_views", label: "Views", type: "number", width: "70px" },
  { key: "notes", label: "Notes", type: "textarea", width: "200px" },
];

type Tab = "reel" | "post" | "story" | "carousel";
    ...
    <div className="flex flex-col h-full overflow-hidden">
      <div className="px-6 pt-5 pb-3 flex-shrink-0 border-b border-border/50">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-foreground tracking-tight">Instagram</h1>
            <p className="text-muted text-xs mt-0.5">Instagram content management</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 min-h-0 overflow-hidden">
        <ContentSheet
          ...
          queryParams={{ platform: "instagram", content_type: tab }}
          statusOptions={STATUS_OPTIONS}
          statusColors={STATUS_COLORS}
          defaultNewRow={{ platform: "instagram", content_type: tab, status: "draft" }}
        />
      </div>
    </div>
  );
