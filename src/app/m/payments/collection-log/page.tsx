      ...
      <div className="px-6 pt-5 pb-3 flex-shrink-0 border-b border-border/50">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center gap-3">
            ...
            />
            <PermissionGate module="payments" subModule="payments-collection-log" action="canCreate">
              <button
              ...
              {entries.length === 0 && !newRow ? (
                ...
                entries.map((entry, idx) => (
                  <tr key={entry.id} className="border-b border-border/50 hover:bg-surface-hover/50 transition-colors">
                    ...
                    {/* Actions */}
                    <td className="px-3 py-2">
                      <PermissionGate module="payments" subModule="payments-collection-log" action="canDelete">
                        {deletingId === entry.id ? (
                          <div className="flex items-center gap-1">
                            <button
