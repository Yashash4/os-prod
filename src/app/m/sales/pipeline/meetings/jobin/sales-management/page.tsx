            ...
            {filteredRecords.length === 0 ? (
              ...
              <tr key={record.opportunity_id} className="border-b border-border/50 hover:bg-surface-hover/50 transition-colors">
                ...
                <td className="px-3 py-2 text-xs border-r border-border">
                  <PermissionGate module="sales" subModule="sales-jobin-sales" action="canEdit" fallback={
                ...
                <td className="px-2 py-1.5 border-r border-border">
                  <PermissionGate module="sales" subModule="sales-jobin-sales" action="canApprove" fallback={
                ...
                <td className="px-3 py-2">
                  <div className="flex items-center gap-1.5">
                    ...
                    <PermissionGate module="sales" subModule="sales-jobin-sales" action="canEdit">
                      <button
